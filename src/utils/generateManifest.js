...
/**
 * Builds a plain text representation of the current data structure ready for the manifest view.
 *
 * Uses lodash templates to make this a quick snapshot with a complex hierarchy.
 *
 * @param {Object[]} rooms
 * @return {String}
 */
function generateManifest(rooms) {
    var heavy = getHeavy(rooms);
    var fragile = getFragile(rooms);
